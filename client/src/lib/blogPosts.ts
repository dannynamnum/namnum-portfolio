...
export const blogPosts: BlogPost[] = [
  {
    slug: "senior-product-designer-ai-workflow",
    title: "Faster Is Easy Now. Knowing What's Wrong Is Still the Job.",
    category: "AI / Design Process",
    date: "2026-09-15",
    readTime: "5 min read",
    excerpt:
      "AI changed how fast I deliver. It didn't change what I'll sign off on. How I actually use it on PENN and GL Homes work, and where it stops.",
    image: "/assets/penn-kiosk-design-system.webp",
    imageAlt:
      "The PENN Entertainment kiosk design system: color palette, typography, and key components including the bottom navigation bar",
    seoTitle: "How a Senior Product Designer Uses AI Without Lowering the Bar",
    seoDescription:
      "A senior product designer on what AI absorbed in his workflow, what it got confidently wrong on the PENN Entertainment kiosks, and where it stops in regulated work.",
    body: [
      "Most of what gets written about AI in design is about speed.",
      "Speed is real. I get to a design direction in a day instead of three, and I run four to six projects at a time instead of one or two. But speed was never the hard part of this work, and it isn't now.",
      "The hard part is knowing when the output is wrong. That is what twenty years turns out to be for.",
      "## The ten-minute user journey.",
      "I was on a call to close out the wireframes for a promotional game on the PENN Entertainment kiosks. The vendor building the game was on, the internal team was on, and we were walking through screens we had been iterating on for weeks. The project had come to us with a business case and no user journey. The journey had to be found, and wireframes were how we found it.",
      "![The full PENN Pick Six screen inventory in Figma: kiosk and mobile states for entering, confirming, printing, and checking picks.](/assets/penn-picksix-screen-inventory.webp \"Every kiosk and mobile state for Pick Six. This is what the ten minutes were built on.\")",
      "Partway through, the director of IT shared his screen. While we were talking, he had fed everything we built into his AI and asked it for a user journey. It gave him a different-looking version of the same flow. It took him about ten minutes, he said, and we had spent weeks.",
      "For anyone without the background, that sounds true. I could feel it landing that way.",
      "I was asked what I thought, so I said it. We had not spent weeks drawing boxes. We had spent weeks deciding where the flow forks, where a screen needs more detail, where it needs less, and where to take friction out. His AI took all of that as context and redrew it. It did not do weeks of work in ten minutes. It used weeks of work in ten minutes.",
      "He didn't respond to me on the call. Afterward, though, the two of us worked closely. His version had a couple of real findings in it, so we folded those in, cut screens, and cut friction. On the next team call I said, in front of everyone, that we would not have gotten there without his push.",
      "There is a place for AI in this work. It should not be the one driving.",
      "## The AI was right about the menu, and the menu was still wrong.",
      "On the same project, the AI recommended the menu go across the top. Its reasoning was sound. That is where users expect a menu, it follows the industry standard, and it lowers friction. I designed a few screens that way and brought them to the team, and everyone agreed, the other designers, product, and the engineers on the call.",
      "Then we put it on a test kiosk. Shorter guests couldn't reach the top of the screen. Guests in wheelchairs couldn't reach it at all. Lowering the kiosk would have fixed it for them and broken it for everyone else.",
      "I knew the answer immediately, because I had already been through it at GL Homes. I put a 75-inch touchscreen in a sales center so buyers could compare two floor plans side by side. The menu was across the top, and it tested fine on our computers. Once it was on the wall, I filmed people using it, and anyone under about five foot five couldn't reach the navigation. I moved to a 65-inch screen, mounted it lower, and put the menu at the bottom. There was pushback because it looked different from what people expected. The footage settled it. Complaints stopped, more buyers used it, and GL Homes rolled it out to twelve other communities.",
      "![A buyer at the GL Homes sales center touching the Compare Floor Plans screen, with the control at the bottom of the display.](/assets/gl-homes-floor-plan-wall-screen.webp \"The GL Homes floor plan comparison screen after the fix: 65 inches, mounted lower, controls at the bottom where every buyer can reach them.\")",
      "The PENN kiosk menu went to the bottom. I regrouped the screens into sections that matched each button, we ran another round, and everyone signed off. I handed engineering the research, the designs, the assets, and a document explaining what changed and why. My contract ended before it was built.",
      "The AI was not wrong on paper. The room was not wrong on paper either. The recommendation was reasonable, and reasonable is not the same as right. Someone has to have stood in front of the hardware before.",
      "## The step that changed the most.",
      "Three years ago, getting a client to a design direction took one to three days and a few rounds. I would take the logo, ask what font they used, pull colors in Illustrator, look for a pairing, and design an entire page so they had something to react to. They would react. They liked it or they didn't, and they rarely knew why. Then a red they loved on the homepage would show up on five more pages, and they would decide they didn't love it after all.",
      "Now I give the AI the logo and whatever context I have and ask for a style tile: color and type together on one small artifact. It gives me ten color schemes, and I pick one. It gives me ten font combinations that still work with the logo, and I pick one. I choose the imagery and the crops myself, and I send the client a dark version and a light version.",
      "On a recent site for an interior designer, that took about an hour. I sent it that day, got feedback that day, adjusted, and sent it back. One day from nothing to a direction both sides agreed on, with type, color, and imagery locked and the start of a design system already sitting in Figma.",
      "![Dark style tile for an interior designer's website: hero headline over a holiday dining room, typography specs, five-color palette with roles, and button states.](/assets/style-tile-interior-designer-dark.webp \"The dark version of the style tile. Color, type, and imagery on one artifact, about an hour in. The client picked the light one the same day.\")",
      "That is now the pattern for most of the groundwork: font pairings, vertical rhythm, button states, the first draft of a style guide. The AI produces the options and I make the choice. The client sees the whole direction before anything is built on top of it, and that is what stops the reversal on page five.",
      "## Where it stops.",
      "Most writing about AI workflows assumes you can put anything into a model and ship what comes out. Casino gaming is not that world, and nobody handed me a policy for it.",
      "Real player data never went into any AI tool, or into Figma. The test system ran on fictional data with the right fields and realistic values, because the components had to fit real data shapes. None of it belonged to anyone.",
      "The harder call was the vendor. They were building the game itself and had produced screens for the whole flow. The team, meanwhile, was still deciding where the line should sit: the vendor owns everything, or we own the entry and the exit and hand them the game in the middle, or we build it all ourselves. I kept the vendor's screens out of the model on purpose. If the AI absorbed how they had chosen to handle the data, it would design around that, and the line was ours to draw. So I designed about five entry screens and the exit screens, and where the game went I put a placeholder that said the self-contained game plays here, and another that said here is where the guest comes back. The rules of the game stayed on our side and went through legal.",
      "![PENN Pick Six kiosk flow: the Enter the Drawing screen, a black placeholder where the vendor's number picker runs, and the Winning Numbers screen.](/assets/penn-picksix-entry-game-exit.webp \"The PENN Pick Six flow. I designed the entry and the exit. The black box in the middle is the vendor's game, and it never went into the model.\")",
      "The team landed on the split. My screens went through without rework, because nothing in them was built around the vendor's version.",
      "What can go into the model is a design decision. It is not a setting.",
      "## My recommendation.",
      "Give the AI the parts of the work where more options make you better, and keep the parts where being wrong costs somebody something. That line moves from project to project, and drawing it is the work.",
      "I used to run one or two projects at a time. Now it's four to six, at both ends of the budget, and the standard on the small ones is the same as on the large ones. None of that changed what I'll put my name on.",
      "If you have a project where some of the work can't go through an AI tool and someone has to decide which parts, that is the one I want to hear about.",
    ],
    relatedWork: {
      label: "Case study: PENN Entertainment",
      href: "/work/penn-entertainment",
      description: "The kiosk redesign behind both stories in this article, from floor research to the design system.",
    },
    relatedInsight: {
      label: "Keep reading: Nobody Had Watched Real People Use It. So I Did.",
      href: "/insights/nobody-had_watched-real-people-use-it",
      description: "A day on the casino floor watching guests use the PENN kiosks, and the seven fixes that came out of it.",
    },
  },
  {
    slug: "how-do-real-estate-agents-use-websites-to-generate-more-leads",
    title: "How Do Real Estate Agents Use Websites to Generate More Leads?",
    category: "Real Estate / Lead Generation",
    date: "2026-09-02",
    readTime: "4 min read",
    excerpt:
      "A real estate website should do more than display listings. It should help the right buyer take the next step and make sure the inquiry reaches the right person.",
    seoTitle: "How Real Estate Agents Generate Leads From Websites",
    seoDescription:
      "How real estate agents can use a website to attract qualified buyers, create lower-friction next steps, and turn website visits into leads.",
    body: [
      "A real estate website should do more than display listings.",
      "It should help the right person find the right information, decide that you understand what they need, and take the next step without having to work too hard for it.",
      "That is the difference between a website that gets traffic and a website that helps generate business.",
      "## Start with the buyer, not the brokerage.",
      "The first mistake I see is building the site around the organization. The brokerage wants to show every service. The agent wants to show every listing. The marketing team wants to promote every community.",
      "The buyer does not care about the org chart. They want to know whether you can help with the decision in front of them.",
      "A relocation buyer, a first-time buyer, and someone looking for a waterfront condo should not have to follow the same path. Give each person a clear way into the site based on what they are trying to do.",
      "## Make the first step smaller.",
      "Most sites ask for too much too soon. They put a big \"Contact me\" button in front of someone who is still researching neighborhoods or comparing options.",
      "A better funnel gives people different ways to continue:",
      "• Early research: a useful neighborhood guide, availability alert, or community comparison",
      "• Active consideration: an agent match, short intake, saved search, or request for more information",
      "• Ready to talk: a call, showing request, tour, or direct consultation",
      "The point is not to hide the contact form. It is to give people an appropriate next step at every level of intent.",
      "## Build pages that can actually attract search traffic.",
      "The homepage is rarely the only page that should generate leads.",
      "Create useful pages for the questions and places your buyers care about. That might be a community guide, a neighborhood comparison, a page for a property type, or a practical answer to a question people ask before they call an agent.",
      "Each page should make three things clear: who it is for, what the visitor will learn, and what they can do next.",
      "A page that ranks but does not help someone decide is not doing enough. A page that looks polished but cannot be found is not doing enough either.",
      "## Route every inquiry somewhere useful.",
      "A lead is not generated when someone presses submit. It is generated when the inquiry reaches the right person and gets a response.",
      "Test the full path. Fill out the form on a phone. Confirm the notification arrives. Check that the source and page are recorded. Make sure the team knows who owns the follow-up.",
      "If the form goes into a shared inbox nobody checks, the website is not generating leads. It is collecting them.",
      "## Measure the path, not just the traffic.",
      "Traffic is useful context. It is not the outcome.",
      "Look at which pages bring people in, where they leave, which CTAs get used, how many inquiries are qualified, and how quickly someone follows up. That tells you where the experience needs work.",
      "A small improvement to the page that already attracts the right audience can be worth more than a complete redesign of a page nobody visits.",
      "## The website is part of the sales team.",
      "The best real estate websites do some of the early work before an agent ever speaks with a buyer. They explain the market, reduce uncertainty, set expectations, and make the next conversation more productive.",
      "I help real estate brands design websites around that path, from the first search to the qualified inquiry. More traffic is useful. Better movement through the site is what turns it into a business asset.",
    ],
    relatedInsight: {
      label: "Keep reading: What makes a real estate website convert?",
      href: "/insights/what-makes-a-real-estate-website-convert-visitors-into-leads",
      description: "A closer look at buyer intent, mobile UX, speed, and the CTAs that turn traffic into conversations.",
    },
  },
  {
    slug: "whats-the-difference-between-a-free-and-paid-real-estate-website",
    title: "What's the Difference Between a Free and Paid Real Estate Website?",
    category: "Real Estate / Strategy",
    date: "2026-09-02",
    readTime: "4 min read",
    excerpt:
      "A free website can be enough to establish a presence. A paid website should earn its place by helping the business attract, serve, and convert the right audience.",
    seoTitle: "Free vs Paid Real Estate Websites: What Is the Difference?",
    seoDescription:
      "Compare free and paid real estate websites by cost, control, credibility, SEO, lead capture, and the level of business support each option provides.",
    body: [
      "The difference is not simply whether you pay a monthly fee.",
      "The real difference is what the website is expected to do for the business, and how much control you need over the experience once it is live.",
      "A free website can be a reasonable starting point. It can also become expensive in a different way if it limits your brand, your content, your leads, or your ability to change direction.",
      "## What a free website is good at.",
      "If you are a new agent testing a niche, a free profile or a basic no-cost site may be enough to give people a place to find your contact information.",
      "It can help you establish a name, a service area, and a simple way to get in touch. That is useful when the alternative is having no online presence at all.",
      "The key is to be honest about the job. A free site is usually a presence. It is not automatically a marketing system.",
      "## What you are giving up.",
      "Free platforms often limit the things that make a website distinct and useful:",
      "• Control over the design and structure",
      "• Ownership of the domain, content, and customer data",
      "• Custom pages for communities, neighborhoods, and buyer questions",
      "• The ability to connect forms and inquiries to the tools your team uses",
      "• Technical control over SEO, performance, and redirects",
      "• A clear path to grow when the business gets more complex",
      "Those limits may not matter at the beginning. They matter when the website becomes responsible for attracting leads or supporting a larger team.",
      "## What a paid website should provide.",
      "A paid website should buy you more than a nicer template.",
      "It should give you a clearer message, a better structure, stronger control over the buyer journey, and a way to connect the experience to the rest of the business.",
      "That might include custom landing pages, neighborhood content, IDX or CRM integrations, better analytics, faster performance, accessible interactions, and the ability to make changes without starting over.",
      "If you are paying for a site that still looks and behaves like every other template, the price is not solving the important problem.",
      "## Think about the cost of being stuck.",
      "A cheap site can become costly when every change requires a workaround, when the domain is tied to a provider, or when the platform does not let you build the pages your audience needs.",
      "You may also pay in missed opportunities. A visitor cannot contact the right person if the form does not route correctly. A buyer cannot find a community if the navigation is built around the internal organization. A page cannot perform in search if you cannot control its content or structure.",
      "The question is not whether a paid website guarantees more leads. It does not. The question is whether the investment gives you the control and clarity needed to earn them.",
      "## Which one should you choose?",
      "Choose free if you need a basic presence, have one audience, limited content, and a realistic plan to maintain it yourself.",
      "Choose paid when the website needs to support a niche, a personal brand, multiple communities, a brokerage team, search visibility, lead routing, or a more considered buyer journey.",
      "And do not assume paid means massive. You can start with a focused site and expand it as the business proves what it needs.",
      "## My recommendation.",
      "Start with the outcome. If the goal is simply to be findable, a basic site may be enough. If the goal is to become the answer for a specific buyer in a specific market, budget for the strategy and control that make that possible.",
      "The best website is not the most expensive one. It is the one that gives the business the right amount of ownership, flexibility, and support for the job it needs to do.",
    ],
    relatedInsight: {
      label: "Keep reading: How much does a professional real estate website cost?",
      href: "/insights/how-much-does-it-cost-to-build-a-professional-real-estate-website",
      description: "A practical breakdown of where a real estate website budget goes, from strategy and content to integrations and QA.",
    },
  },
  {
    slug: "how-do-i-get-my-real-estate-website-to-show-up-in-google-search",
    title: "How Do I Get My Real Estate Website to Show Up in Google Search?",
    category: "Real Estate / Local SEO",
    date: "2026-09-02",
    readTime: "4 min read",
    excerpt:
      "Showing up in Google is not one trick. It is the result of being useful, specific, technically accessible, and clearly tied to the market you serve.",
    seoTitle: "How to Get a Real Estate Website to Show Up in Google",
    seoDescription:
      "A practical local SEO guide for real estate websites: choose a market, build useful pages, improve technical foundations, and earn local trust.",
    body: [
      "There is no single switch that makes a real estate website show up in Google.",
      "Search visibility comes from a set of decisions that work together: choosing a clear market, publishing useful content, making the site technically accessible, and giving Google enough evidence to understand who you help and where you work.",
      "The good news is that most of this is not mysterious. It is just work that has to be done in the right order.",
      "## Start with a specific market.",
      "A site that tries to rank for every real estate search in a region is usually too vague to be useful.",
      "Start with the audience you actually want. That could be buyers looking for waterfront condos in a specific city, families comparing master-planned communities, or sellers in a defined neighborhood.",
      "Your pages, titles, headings, and examples should make that focus clear. If the site could belong to any agent in any market, Google and the buyer have the same problem: they do not know what makes it relevant.",
      "## Build pages around real questions.",
      "A homepage is not enough for local SEO.",
      "Create useful pages for the places, property types, and decisions your audience is researching. Neighborhood guides, community comparisons, relocation pages, and answers to practical buyer questions can all serve a purpose when they are genuinely specific.",
      "Do not make a page for every keyword variation just to fill a sitemap. Make a page because it helps someone understand a place or make a decision.",
      "## Make the business information consistent.",
      "Your name, service area, contact information, and business details should be clear and consistent wherever people encounter you.",
      "That includes the website, your business profile, relevant directories, social profiles, and local partnerships. The goal is not to collect listings everywhere. It is to make the business easy to understand and trust.",
      "For agents, the website should also make the person behind the business clear. A buyer should know who you serve, where you work, and why your experience is relevant.",
      "## Fix the technical basics.",
      "Search engines need to access, read, and interpret the site.",
      "Make sure important pages are crawlable, titles and descriptions are specific, headings describe the content, internal links connect related pages, and old URLs redirect to useful destinations. The site should load well on a phone and work for people using different devices and abilities.",
      "Technical SEO does not replace useful content. It makes useful content easier to find and understand.",
      "## Earn local trust.",
      "Local visibility is stronger when the business is connected to the place it serves.",
      "Write from real knowledge. Reference local details that matter to buyers. Build relationships with relevant organizations and businesses. Ask for honest reviews from real clients where appropriate, and make sure the claims on the site can be supported.",
      "A page filled with generic neighborhood language is not local expertise. It is a template with a place name added.",
      "## Give each page a next step.",
      "Ranking is not the finish line. Someone who arrives from Google still needs a clear path through the site.",
      "Offer a next step that matches the page. A neighborhood guide might lead to an availability alert. A relocation page might lead to an agent conversation. A community page might lead to a tour request.",
      "The best SEO page is useful before the visitor ever fills out a form. That usefulness is what earns attention, trust, and eventually action.",
      "## Be patient, then pay attention.",
      "Search visibility compounds over time. Publish useful pages, connect them clearly, watch what people use, and improve the pages that already show potential.",
      "Do not chase every ranking change. Build a site that deserves to be found by the people you want to work with.",
      "I help real estate brands turn local search into a clearer buyer path, not just a list of keywords. The goal is to show up for the right people and give them a reason to stay.",
    ],
    relatedInsight: {
      label: "Keep reading: What features should every real estate website have?",
      href: "/insights/what-features-should-every-real-estate-website-have",
      description: "A practical checklist for the pages, paths, and features that help real estate buyers find and trust you.",
    },
  },
  {
